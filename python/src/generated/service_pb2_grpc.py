...
class UnstableServiceStub(object):
    """Сервис, имитирующий нестабильную работу (Payment Service, Database Service и т.д.)
    """
    ...
    def __init__(self, channel):
        ...
        self.ProcessData = channel.unary_unary(
                '/resilience.UnstableService/ProcessData',
...
class UnstableServiceServicer(object):
    """Сервис, имитирующий нестабильную работу (Payment Service, Database Service и т.д.)
    """
...
def add_UnstableServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'resilience.UnstableService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('resilience.UnstableService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class UnstableService(object):
    """Сервис, имитирующий нестабильную работу (Payment Service, Database Service и т.д.)
    """
